...
namespace KS3Sample
{
    class KS3Sample
    {
        ...
        static String objKeyNameFileData = "test.doc";

        //static String inFilePath = "D:\\test.doc";
		...
		//{
		//	if ( accessKey.Equals("AKLTCz8pC3FHTRSaKSbqXRkkLQ") || secretKey.Equals("AKLTCz8pC3FHTRSaKSbqXRkkLQ") )
		//	{
  ...
  //          //bucketName = "test-ks3-bucket-" + new Random().Next();
		...
		private static bool putObject()
		{
			try
            {
                ...
                FileInfo file = new FileInfo("d:/test.doc");
        ...
        private static bool uploadPart() {
            string path = @"D:\test.doc";//上传文件路径,例如E:\tool\aa.rar
